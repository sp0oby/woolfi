...
export const robinhoodAssets = {
  URU: asset("URU", "URU", "staking", "0x9fbe210007dDd8389f98d0253018e65CC48b9D24"),
  WETH: asset("WETH", "Wrapped Ether", "crypto", "0x0Bd7D308f8E1639FAb988df18A8011f41EAcAD73"),
  USDG: asset("USDG", "Global Dollar", "stable", "0x5fc5360D0400a0Fd4f2af552ADD042D716F1d168"),
  ...
  XLK: asset("XLK", "Technology Select Sector SPDR", "etf", "0x15Cd20759CE7F3285c29A319dE2D1A2e098c6f43"),
  SMH: asset("SMH", "VanEck Semiconductor ETF", "etf", "0x072f979c2CAc8e1391B0162a87Fee094bF8744a0"),
  SOXX: asset("SOXX", "iShares Semiconductor ETF", "etf", "0x75742c18BC1f1C5c5f448f4C9D9C6F66dafAAa38"),
...
function asset(
  ...
  return {symbol, name, kind, address};
}
